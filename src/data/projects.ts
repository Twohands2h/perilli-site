...
export const projects: Project[] = [
  {
    ...
    solutionIt: 'Ho sviluppato un sistema di particelle e distorsioni luminose che evocano il passaggio dimensionale, combinando compositing multilayer con elementi 3D. Ogni shot è stata lavorata frame-by-frame per garantire un&apos;integrazione fotorealistica con l&apos;atmosfera distopica del film.',
    solutionEn: 'I developed a system of particles and light distortions evoking dimensional passage, combining multilayer compositing with 3D elements. Every shot was worked frame-by-frame to ensure photorealistic integration with the film&apos;s dystopian atmosphere.',
  ...
  },
  {
    ...
    solutionIt: 'Ho modellato il telaio in 3ds Max partendo dai disegni tecnici originali. Le spline del telaio sono state animate come se si costruissero davanti agli occhi dello spettatore, con simulazioni di fiamme e particelle create con tyFlow che richiamano il processo di saldatura artigianale. Dal visualizzare le materie prime fino a presentare il prodotto finito.',
  ...
  },
  {
    ...
    solutionIt: 'Ho progettato sistemi particellari complessi che simulano flussi di energia, vortici luminosi e strutture organiche in costante trasformazione. Ogni animazione è stata ottimizzata per la proiezione su larga scala, con particolare attenzione alla fluidità e alla resa cromatica.',
    solutionEn: 'I designed complex particle systems simulating energy flows, light vortexes and organic structures in constant transformation. Each animation was optimized for large-scale projection, with particular attention to fluidity and color rendering.',
  ...
  },
  {
    ...
    solutionEn: 'Integrated editing-color-graphics workflow in DaVinci Resolve, with After Effects passes for more complex animations. The advantage of managing everything in a single pipeline allowed rapid iterations with production and stylistic coherence across the documentary.',
  ...
  },
  {
    ...
    solutionIt: 'Montaggio narrativo ritmico che segue l&apos;energia della danza, con un color grading che distingue le epoche (archivio vs contemporaneo) mantenendo coerenza emotiva. Il workflow integrato ha permesso di sincronizzare ritmo del montaggio e look cromatico in tempo reale.',
    solutionEn: 'Rhythmic narrative editing following the energy of dance, with color grading distinguishing eras (archive vs contemporary) while maintaining emotional coherence. The integrated workflow allowed synchronizing editing rhythm and chromatic look in real time.',
  ...
  },
  {
    ...
    solutionIt: 'Ho sviluppato un approccio ibrido che combina la fluidità dell&apos;animazione 2D con la profondità degli ambienti 3D. Layer sovrapposti, distorsioni e transizioni organiche creano un&apos;estetica stratificata e ricercata.',
    solutionEn: 'I developed a hybrid approach combining the fluidity of 2D animation with the depth of 3D environments. Overlapping layers, distortions and organic transitions create a layered, sophisticated aesthetic.',
