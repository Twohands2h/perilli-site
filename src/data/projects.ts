...
export const projects: Project[] = [
    ...
    },
    {
        ...
        challengeIt: 'Gestire l\u2019intero flusso di <a href="/post-produzione">post-produzione</a> di un documentario broadcast: montaggio narrativo da materiale eterogeneo (interviste, materiale d\u2019archivio storico, footage originale girato nei luoghi della storia), color grading coerente su fonti visivamente molto diverse tra loro, e animazioni grafiche che accompagnassero la narrazione senza appesantirla.',
        challengeEn: 'Managing the entire <a href="/en/post-production">post-production</a> pipeline for a broadcast documentary: narrative editing from heterogeneous material (interviews, historical archive footage, original footage shot at the actual locations), coherent color grading across visually very different sources, and graphic animations that supported the narrative without weighing it down.',
