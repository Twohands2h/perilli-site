...
export const projects: Project[] = [
    {
        ...
        solutionIt: 'Ho sviluppato un sistema di particelle e distorsioni luminose che evocano il passaggio dimensionale, combinando <a href="/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">compositing multilayer</a> con elementi 3D. Ogni shot \u00E8 stata lavorata frame-by-frame per garantire un\u2019integrazione fotorealistica con l\u2019atmosfera distopica del film.\n\nRegia: Riccardo Suriano.',
        solutionEn: 'I developed a system of particles and light distortions evoking dimensional passage, combining multilayer <a href="/en/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">compositing</a> with 3D elements. Every shot was worked frame-by-frame to ensure photorealistic integration with the film\u2019s dystopian atmosphere.\n\nDirected by Riccardo Suriano.',
        resultIt: 'Gli effetti visivi hanno dato vita alla visione del regista, trasformando location reali in un mondo post-apocalittico credibile. Il cortometraggio ha completato la post-produzione ed \u00E8 in fase di distribuzione festival. Leggi il <a href="/blog/breakdown-vfx-along-came-ruby" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">breakdown VFX completo</a> di questo progetto.',
        resultEn: 'The visual effects brought the director\u2019s vision to life, transforming real locations into a credible post-apocalyptic world. The short film has completed post-production and is in festival distribution. Read the <a href="/en/blog/vfx-breakdown-along-came-ruby" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">complete VFX breakdown</a> of this project.',
        ...
        contentBlocks: [
            ...
            { type: 'text', textIt: 'Software: After Effects per il compositing multilayer, Mocha Pro per il tracking, 3ds Max per gli elementi 3D, DaVinci Resolve per il color grading finale.\n\nRegia: Riccardo Suriano. Cast: Alexandra Boulas, Liz Kastner.\n\nLeggi il <a href="/blog/breakdown-vfx-along-came-ruby" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">breakdown VFX completo</a> sul blog.', textEn: 'Software: After Effects for multilayer compositing, Mocha Pro for tracking, 3ds Max for 3D elements, DaVinci Resolve for final color grading.\n\nDirected by Riccardo Suriano. Cast: Alexandra Boulas, Liz Kastner.\n\nRead the <a href="/en/blog/vfx-breakdown-along-came-ruby" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">complete VFX breakdown</a> on the blog.' },
        ],
    },
    {
        ...
        briefingIt: 'Video di lancio per la Guerciotti Sixty: telaio in carbonio Mitsubishi T65, design aerodinamico estremo con avantreno completamente integrato. Edizione limitata a 60 esemplari per il 60\u00B0 anniversario del marchio milanese.\n\nIl brief: raccontare la nascita di questo telaio \u2014 dalle materie prime al prodotto finito \u2014 attraverso un\u2019<a href="/animazione-3d" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">animazione 3D</a> che ne esaltasse la precisione costruttiva e l\u2019innovazione tecnica.',
        briefingEn: 'Launch video for the Guerciotti Sixty: Mitsubishi T65 carbon frame, extreme aerodynamic design with fully integrated front end. Limited edition of 60 units for the 60th anniversary of the Milan-based brand.\n\nThe brief: tell the story of this frame\u2019s creation \u2014 from raw materials to finished product \u2014 through <a href="/en/3d-animation" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">3D animation</a> highlighting its construction precision and technical innovation.',
    ...
    },
    {
        ...
        challengeIt: 'Gestire l\u2019intero flusso di <a href="/post-produzione" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">post-produzione</a> di un documentario broadcast, interamente da Roma: montaggio narrativo da materiale eterogeneo (interviste, materiale d\u2019archivio storico, footage originale girato nei luoghi della storia), color grading coerente su fonti visivamente molto diverse tra loro, e animazioni grafiche che accompagnassero la narrazione senza appesantirla.',
        challengeEn: 'Managing the entire <a href="/en/post-production" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">post-production</a> pipeline for a broadcast documentary, entirely from Rome: narrative editing from heterogeneous material (interviews, historical archive footage, original footage shot at the actual locations), coherent color grading across visually very different sources, and graphic animations that supported the narrative without weighing it down.',
...

    {
        ...
        solutionIt: 'Ho sviluppato uno studio completo del personaggio: fonemi per il lipsync, espressioni facciali, varianti con e senza denti. Sottoposto a Julien Temple per approvazione. Una volta validato il look, ho lavorato scena per scena: rotoscoping del volto originale, ricostruzione digitale, animazione labiale sincronizzata con il dialogo e <a href="/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">compositing</a> fotorealistico per integrare il volto animato nel girato.',
        solutionEn: 'I developed a complete character study: phonemes for lipsync, facial expressions, variants with and without teeth. Submitted to Julien Temple for approval. Once the look was validated, I worked scene by scene: rotoscoping the original face, digital reconstruction, lip-sync animation matched to dialogue and photorealistic <a href="/en/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">compositing</a> to integrate the animated face into the footage.',
    ...
    },
    {
        ...
        challengeIt: 'Integrare un elemento 3D \u2014 la gabbia \u2014 in scene girate con attori, con movimenti di camera e azioni complesse. La gabbia doveva sembrare fisicamente presente nella scena, con ombre, riflessi e interazione con la luce ambiente. Tutto il lavoro di <a href="/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">VFX e compositing</a> gestito da Roma.',
        challengeEn: 'Integrating a 3D element \u2014 the cage \u2014 into scenes shot with actors, with camera movements and complex actions. The cage had to feel physically present in the scene, with shadows, reflections and interaction with ambient light. All <a href="/en/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">VFX and compositing</a> work managed from Rome.',
    ...
    },
    {
        ...
        solutionIt: 'Ho realizzato in Unreal Engine 5 il mondo onirico dello spot \u2014 il Colosseo, statue classiche, colonne e superfici d\u2019acqua riflettente con illuminazione cinematografica. I gioielli sono stati modellati in 3ds Max dai disegni tecnici originali con materiali fisicamente accurati (metalli, diamanti, riflessi). Movimenti di camera che guidano lo sguardo dal panorama al dettaglio del singolo anello. Color grading finale in DaVinci Resolve. <a href="/animazione-3d" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Scopri i miei servizi di animazione 3D</a>.',
        solutionEn: 'I built the spot\u2019s dreamlike world in Unreal Engine 5 \u2014 the Colosseum, classical statues, columns and reflective water surfaces with cinematic lighting. Jewelry was modeled in 3ds Max from original technical drawings with physically accurate materials (metals, diamonds, reflections). Camera movements guide the eye from panorama to individual ring detail. Final color grading in DaVinci Resolve. <a href="/en/3d-animation" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Discover my 3D animation services</a>.',
...

    {
        ...
        solutionIt: 'Ho creato le meduse in 3D e le ho integrate scena per scena nelle immagini degli uffici attraverso <a href="/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">compositing</a> in After Effects. Ogni medusa ha luce propria che interagisce con l\u2019ambiente circostante \u2014 riflessi sui vetri delle pareti, alone luminoso sulle superfici, ombre coerenti. Color grading in DaVinci Resolve per uniformare il look cinematografico blu-verde che trasforma l\u2019ufficio in un acquario.',
        solutionEn: 'I created the jellyfish in 3D and integrated them scene by scene into the office images through <a href="/en/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">compositing</a> in After Effects. Each jellyfish emits its own light that interacts with the surrounding environment \u2014 reflections on glass walls, luminous halos on surfaces, coherent shadows. Color grading in DaVinci Resolve to unify the cinematic blue-green look that transforms the office into an aquarium.',
    ...
    },
    {
        ...
        solutionIt: 'Ho realizzato il video in After Effects con Element 3D e <a href="/animazione-3d" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">3ds Max</a>: un\u2019esplosione particellare che si trasforma progressivamente nel polo multifunzionale. Il nucleo iniziale \u00E8 pura energia astratta \u2014 particelle, luce, materia in formazione \u2014 che si organizza e prende forma architettonica. Il racconto visivo procede dal caos alla struttura, dal sogno alla realt\u00E0.',
        solutionEn: 'I created the video in After Effects with Element 3D and <a href="/en/3d-animation" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">3ds Max</a>: a particle explosion that progressively transforms into the multifunctional hub. The initial nucleus is pure abstract energy \u2014 particles, light, matter in formation \u2014 organizing and taking architectural form. The visual narrative proceeds from chaos to structure, from dream to reality.',
...

    {
        ...
        solutionIt: 'Avendo il controllo su regia, <a href="/post-produzione" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">montaggio e color grading</a>, ho potuto costruire il video come un\u2019unica visione dall\u2019inizio alla fine. Il grading supporta la narrazione emotiva del brano, il montaggio segue il ritmo musicale, e i <a href="/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">VFX</a> aggiungono momenti di magia visiva dove la musica lo richiede.',
        solutionEn: 'Having control over directing, <a href="/en/post-production" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">editing and color grading</a>, I could build the video as a single vision from start to finish. The grading supports the song\u2019s emotional narrative, the editing follows the musical rhythm, and <a href="/en/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">VFX</a> add moments of visual magic where the music demands it.',
    ...
    },
    {
        ...
        solutionIt: 'Ho realizzato l\u2019animazione in 2.5D in After Effects \u2014 una tecnica che d\u00E0 alle illustrazioni 2D le sembianze del 3D attraverso profondit\u00E0, ombre e movimenti su pi\u00F9 piani. La goccia d\u2019acqua \u00E8 il personaggio che racconta il video: guida lo spettatore attraverso i passaggi del bonus idrico con <a href="/motion-graphics" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">transizioni fluide e tipografia animata</a>.',
        solutionEn: 'I created the animation in 2.5D in After Effects \u2014 a technique that gives 2D illustrations a 3D appearance through depth, shadows and multi-plane movements. The water drop is the character narrating the video: it guides the viewer through the water bonus steps with <a href="/en/motion-graphics" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">fluid transitions and animated typography</a>.',
    ...
    },
    {
        ...
        thumbnail: '/images/portfolio/floverr/floverr-hero.webp',
        thumbnailAlt: { it: `VFX per il film Floverr`, en: `VFX for the film Floverr` },
        heroImage: '/images/portfolio/floverr/floverr-hero.webp',
        heroAlt: { it: `Floverr — film in produzione, VFX Piero Perilli`, en: `Floverr — film in production, VFX by Piero Perilli` },
        images: [],
        tools: ['After Effects', 'Mocha Pro', '3ds Max', 'Photoshop'],
        briefingIt: `Film diretto da Anita Udeep, costruito interamente su flashback della protagonista visualizzati come un videogioco. Serviva un HUD di gioco completo e ogni tipo di effetto visivo — dal green screen alla pulizia del set. In produzione.`,
        briefingEn: `Film directed by Anita Udeep, built entirely on the protagonist's flashbacks visualized as a video game. A complete game HUD was needed along with every type of visual effect — from green screen to set cleanup. In production.`,
        ...
        solutionIt: `Ho progettato e animato l'HUD del videogioco da zero, integrandolo nelle scene con <a href="/motion-graphics" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">motion graphics</a> e tracking. Per le scene dal vivo: compositing green screen, <a href="/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">rimozione cavi</a>, estensione digitale degli ambienti e inserimento di elementi CG tracciati in camera. Un progetto che ha richiesto l'intero spettro del mio <a href="/post-produzione" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">workflow integrato</a>.`,
        solutionEn: `I designed and animated the video game HUD from scratch, integrating it into scenes with <a href="/en/motion-graphics" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">motion graphics</a> and tracking. For live-action scenes: green screen compositing, <a href="/en/vfx" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">wire removal</a>, digital set extension and insertion of camera-tracked CG elements. A project that required the full spectrum of my <a href="/en/post-production" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">integrated workflow</a>.`,
        resultIt: `Film in produzione. Un film dove il confine tra mondo reale e videogioco si dissolve in modo credibile — con effetti visivi che spaziano dal fotorealistico alla grafica stilizzata, tutti integrati in un unico linguaggio visivo.`,
        resultEn: `Film in production. A film where the boundary between real world and video game dissolves believably — with visual effects spanning from photorealistic to stylized graphics, all integrated into a single visual language.`,
    },
    {
