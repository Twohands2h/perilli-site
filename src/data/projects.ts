...
export const projects: Project[] = [
    ...
    // ──────────────────── VFX / CINEMA ────────────────────
        ...
        briefingIt: 'Documentario diretto da Julien Temple su Jean Pigozzi \u2014 collezionista, fotografo, personaggio eccentrico del mondo dell\u2019arte. Durante tutto il film, Pigozzi \u00E8 accompagnato da Mr. Limo, un pupazzo di plastica a grandezza naturale con un volto fisso. La richiesta del regista: farlo parlare e reagire in modo credibile in ogni scena, come fosse un personaggio vivo. In onda su Prime Video.',
        briefingEn: 'Documentary directed by Julien Temple about Jean Pigozzi \u2014 collector, photographer, eccentric figure in the art world. Throughout the film, Pigozzi is accompanied by Mr. Limo, a life-size plastic puppet with a fixed face. The director\u2019s request: make it speak and react believably in every scene, as if it were a living character. Streaming on Prime Video.',
        challengeIt: 'Il volto del pupazzo era rigido e inespressivo \u2014 un unico pezzo di plastica. Per ogni scena dovevo rimuovere il volto originale, ricostruirlo digitalmente e animarlo con movimenti labiali e espressioni credibili, mantenendo coerenza visiva con il materiale fisico. Il tutto in decine di scene con inquadrature, luci e angolazioni diverse.',
        challengeEn: 'The puppet\u2019s face was rigid and expressionless \u2014 a single piece of plastic. For every scene I had to remove the original face, rebuild it digitally and animate it with believable lip movements and expressions, maintaining visual coherence with the physical material. All across dozens of scenes with different framing, lighting and angles.',
