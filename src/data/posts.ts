...
<p>In two years the market will be saturated. Now is when quality and vision make the difference, because competition is still low and demand is high. Directors and producers who invest now in understanding this language — and ally with professionals who can turn it into product — have a significant time advantage.</p>`,
    ...
    // ====== POST 13: Along Came Ruby VFX Breakdown ======
    {
        slug: 'breakdown-vfx-along-came-ruby',
        slugEn: 'vfx-breakdown-along-came-ruby',
        ...
        excerptIt: 'Come ho creato gli effetti dello spaziotempo per un cortometraggio sci-fi, lavorando in DaVinci Cloud con Walter Volpatto — il colorist di Star Wars, Dunkirk e Megalopolis. Il breakdown completo della scena più complessa del film.',
        excerptEn: 'How I created the spacetime effects for a sci-fi short film, working in DaVinci Cloud with Walter Volpatto — the colorist behind Star Wars, Dunkirk and Megalopolis. The complete breakdown of the film\'s most complex scene.',
        date: '2026-03-10',
        readingTime: 9,
        category: 'vfx',
        categoryLabel: { it: 'VFX', en: 'VFX' },
        keywordTarget: 'VFX breakdown cortometraggio',
        thumbnail: '/images/blog/along-came-ruby-vfx-breakdown-hero.webp',
        thumbnailAlt: {
            it: 'Along Came Ruby — effetti visivi della scena spaziotempo',
            en: 'Along Came Ruby — spacetime scene visual effects',
        },
        contentIt: `<p><em>Along Came Ruby</em> è un cortometraggio sci-fi diretto da <a href="https://www.imdb.com/name/nm5388996/" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Riccardo Suriano</a>, girato a Sacramento e ambientato in un mondo post-apocalittico. Ruby, una ragazza di 18 anni, attraversa un paesaggio devastato in cerca del fratello. Durante il viaggio incontra una donna anziana misteriosa — e scopre che passato e futuro sono più vicini di quanto pensasse.</p>

<p>Io ho curato gli effetti visivi. La color è stata fatta da <a href="https://www.imdb.com/name/nm2164371/" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Walter Volpatto</a> — colorist di Hollywood con crediti su Star Wars: The Last Jedi, Dunkirk, Megalopolis, Green Book, Interstellar. Membro dell'Academy, consulente del Science and Technology Council. La fotografia è di Joey Katches.</p>

<p>Questo articolo racconta come abbiamo lavorato insieme — da Roma a Hollywood — sulla scena più complessa del film.</p>
...
<p>Prima di toccare After Effects, io e Riccardo abbiamo passato tempo a parlare. Abbiamo guardato film e serie con sequenze di manipolazione temporale, analizzato cosa funzionava e cosa no, discusso il tono che volevamo. Non stavamo cercando un effetto spettacolare — cercavamo un effetto che servisse la storia.</p>

<p>Questa fase è spesso sottovalutata. Quando un regista e un VFX artist sono allineati sulla visione prima di iniziare, il lavoro tecnico diventa molto più efficiente. Non stai cercando di interpretare un'indicazione vaga — sai esattamente dove andare.</p>
...
<p>Abbiamo testato la pipeline prima di iniziare il lavoro vero. Un test su una scena semplice per verificare che il roundtrip EXR funzionasse senza intoppi — export, lavorazione in After Effects, reimport, verifica della color. Tutto ha filato liscio al primo tentativo. Quando la pipeline è solida, ti puoi concentrare sulla creatività.</p>
...
<p>Walter Volpatto ha fatto la color per alcuni dei film visivamente più memorabili degli ultimi vent'anni. Lavorare sulla stessa timeline di chi ha fatto il grading di Star Wars e Dunkirk ti dà una prospettiva molto chiara su cosa significa qualità a quel livello. Ogni frame che passa per le sue mani ha una coerenza e una profondità che non puoi ottenere con un LUT o un preset.</p>
...
<p>Se devo a qualcuno il fatto di aver lavorato con Walter, è a Riccardo. La sua visione per il film e il suo standard qualitativo hanno portato a costruire un team di quel calibro anche su un cortometraggio indipendente.</p>

<h2>Cosa ho imparato</h2>

<p>Tre cose da questo progetto.</p>

<p>La prima: testa la pipeline prima di iniziare. Non importa quanto sei sicuro che funzionerà. Un test di roundtrip completo — export, lavorazione, reimport, verifica — costa un'ora e può salvarne cento.</p>

<p>La seconda: il tempo speso in preparazione con il regista non è mai sprecato. Le ore che io e Riccardo abbiamo passato a guardare reference e discutere il tono dell'effetto si sono tradotte in un processo di produzione lineare, senza ripensamenti o direzioni cambiate a metà.</p>

<p>La terza: il formato conta. L'EXR ha reso possibile una collaborazione tra Roma e Hollywood senza perdita di qualità. Se avessimo lavorato con formati compressi, ogni passaggio avrebbe introdotto degradazione. La scelta del formato è una decisione creativa, non solo tecnica.</p>

<p>Il film è disponibile su <a href="https://www.youtube.com/watch?v=_TWrVQ-43uk" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">YouTube</a> e <a href="https://filmshortage.com/dailyshortpicks/along-came-ruby/" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Film Shortage</a>. Puoi vedere il mio lavoro sulla scena dello spaziotempo e tutto il lavoro del team nel <a href="/portfolio/along-came-ruby" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">caso studio nel portfolio</a>.</p>

<p><strong>Crediti principali:</strong> Regia <a href="https://www.imdb.com/name/nm5388996/" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Riccardo Suriano</a> — Fotografia Joey Katches — Color <a href="https://www.imdb.com/name/nm2164371/" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Walter Volpatto</a> — VFX Piero Perilli — Montaggio Bryan A. Mackenzie — Con Alexandra Boulas e Liz Kastner.</p>`,

        contentEn: `<p><em>Along Came Ruby</em> is a sci-fi short film directed by <a href="https://www.imdb.com/name/nm5388996/" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Riccardo Suriano</a>, shot in Sacramento and set in a post-apocalyptic world. Ruby, an 18-year-old, crosses a devastated landscape searching for her brother. Along the way she meets a mysterious elderly woman — and discovers that past and future are closer than she thought.</p>

<p>I handled the visual effects. Color grading was done by <a href="https://www.imdb.com/name/nm2164371/" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Walter Volpatto</a> — a Hollywood colorist with credits on Star Wars: The Last Jedi, Dunkirk, Megalopolis, Green Book, Interstellar. An Academy Member and consultant to the Science and Technology Council. Cinematography by Joey Katches.</p>

<p>This article tells how we worked together — from Rome to Hollywood — on the film's most complex scene.</p>
...
<p>Before touching After Effects, Riccardo and I spent time talking. We watched films and series with time manipulation sequences, analyzed what worked and what didn't, discussed the tone we wanted. We weren't looking for a spectacular effect — we were looking for an effect that served the story.</p>

<p>This phase is often undervalued. When a director and a VFX artist are aligned on the vision before starting, the technical work becomes much more efficient. You're not trying to interpret a vague direction — you know exactly where to go.</p>
...
<p>We tested the pipeline before starting the actual work. A test on a simple scene to verify that the EXR roundtrip worked without issues — export, processing in After Effects, reimport, color verification. Everything went smoothly on the first try. When the pipeline is solid, you can focus on creativity.</p>
...
<p>Walter Volpatto has graded some of the most visually memorable films of the past twenty years. Working on the same timeline as someone who has colored Star Wars and Dunkirk gives you a very clear perspective on what quality means at that level. Every frame that passes through his hands has a coherence and depth you can't achieve with a LUT or a preset.</p>
...
<p>If I owe this collaboration to anyone, it's Riccardo. His vision for the film and his quality standards led to building a team of that caliber even on an independent short.</p>

<h2>What I learned</h2>

<p>Three things from this project.</p>

<p>First: test the pipeline before you start. No matter how confident you are it will work. A complete roundtrip test — export, processing, reimport, verification — costs an hour and can save a hundred.</p>

<p>Second: time spent in preparation with the director is never wasted. The hours Riccardo and I spent watching references and discussing the effect's tone translated into a linear production process, with no second-guessing or mid-course direction changes.</p>

<p>Third: format matters. EXR made a Rome-to-Hollywood collaboration possible without quality loss. Had we worked with compressed formats, each pass would have introduced degradation. The format choice is a creative decision, not just a technical one.</p>

<p>The film is available on <a href="https://www.youtube.com/watch?v=_TWrVQ-43uk" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">YouTube</a> and <a href="https://filmshortage.com/dailyshortpicks/along-came-ruby/" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Film Shortage</a>. You can see my work on the spacetime scene and the full team's work in the <a href="/en/portfolio/along-came-ruby" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">portfolio case study</a>.</p>

<p><strong>Key credits:</strong> Director <a href="https://www.imdb.com/name/nm5388996/" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Riccardo Suriano</a> — Cinematography Joey Katches — Color <a href="https://www.imdb.com/name/nm2164371/" target="_blank" rel="noopener noreferrer" class="text-accent underline underline-offset-2 hover:text-text-primary transition-colors">Walter Volpatto</a> — VFX Piero Perilli — Editor Bryan A. Mackenzie — Starring Alexandra Boulas and Liz Kastner.</p>`,
    },
