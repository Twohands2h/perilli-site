    ...
    <section className="py-20 md:py-28 border-t border-border overflow-hidden">
      <div className="section-container">
        ...
        <AnimateOnScroll delay={200}>
          <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-5 mt-12">
            {clients.map((client) => (
              <span
                key={client}
                className="text-base md:text-lg font-bold uppercase tracking-[0.2em] text-text-muted/30
