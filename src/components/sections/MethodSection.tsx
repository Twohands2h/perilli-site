                        ...
                        <div className="text-text-secondary text-sm md:text-base leading-relaxed space-y-5">
                            {isIt ? (
                                <>
                                    ...
                                    <p>Il mio approccio rompe questa catena. Essendo un unico professionista che padroneggia <strong className="text-text-primary">montaggio, color grading ed effetti visivi per cinema e advertising</strong>, offro un workflow fluido e non lineare. Mentre montiamo una scena, possiamo già definire il suo look colore. Se una ripresa richiede un intervento di VFX, posso realizzarlo contestualmente, senza interrompere il flusso creativo. Oggi integro anche strumenti di AI video production nel processo — dove ha senso, dove accelera senza compromettere la qualità.</p>
                                </>
                            ) : (
                                <>
