...
<p>Lavoro su film, documentari, cortometraggi, spot pubblicitari e video musicali. Ogni formato ha le sue regole: un documentario richiede strutturazione di materiale grezzo con interviste, footage di archivio e voice-over. Uno spot richiede precisione al frame e versioni multiple per diversi formati.</p>`,
      image: '/images/services/color-grading-professionale-cinema-advertising-roma.png',
...
<p>I work on films, documentaries, short films, commercials and music videos. Each format has its rules: a documentary requires structuring raw material with interviews, archive footage and voice-over. A commercial demands frame-accurate precision and multiple versions for different formats.</p>`,
      image: '/images/services/color-grading-professionale-cinema-advertising-roma.png',
