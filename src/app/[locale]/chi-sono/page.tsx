              ...
              <div className="text-text-secondary text-sm md:text-base leading-relaxed space-y-4">
                {isIt ? (
                  <>
                    ...
                    <p>Di base a Roma, disponibile per lavori in tutta Italia e per produzioni internazionali.</p>
                  </>
                ) : (
                  <>
                    ...
                    <p>Based in Rome, available for work throughout Italy and for international productions.</p>
                  </>
                )}
              </div>
